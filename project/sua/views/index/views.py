    ...
    def serialize(self, request, *args, **kwargs):
        ...
        if user.is_staff or user.student.power == 1:
            ...
            if user.is_staff:
                ...
                application_set = Application.objects.filter(sua__activity__owner=user,sua__activity__is_created_by_student=False,deleted_at=None).order_by('-created')# 获取该学生创建的活动的申请
